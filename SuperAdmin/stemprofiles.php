...
if(isset($_GET['searchname'])) {
	...
	$sql = "SELECT * FROM student WHERE strand LIKE '%STEM%' LIMIT $offset, $total_records_per_page";
}
...
$sql = "SELECT COUNT(*) AS total_records FROM student WHERE strand LIKE '%STEM%'";
$result = $conn->query($sql);
