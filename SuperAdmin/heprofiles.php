...
if(isset($_GET['searchname'])) {
    ...
    $sql = "SELECT * FROM student WHERE strand LIKE '%ICT-Programming%' LIMIT $offset, $total_records_per_page";
}
...
$sql = "SELECT COUNT(*) AS total_records FROM student WHERE strand LIKE '%ICT-Programming%'";
$result = $conn->query($sql);
					...
					<div class="modal-body">
						...
						<div class="col-12 mb-3">
								...
								<select class="form-select" id="approve" name="approve">
									...
									<option value="REJECT"<?php if ($approve1 == "REJECT") {echo " selected";}?>>REJECT</option>
								</select>
							</div>
