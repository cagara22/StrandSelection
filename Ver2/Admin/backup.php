                ...
                <div class="row w-100">
                    <div class="col-12">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody class="table-group-divider">
                                <tr>
                                    ...
                                    <td class="text-center">BAckup1.sql</td>
                                    <td class="text-center">
                                        <a href="" class="btn btn-view" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="RESTORE">
                                            <img src="./images/restore.png" alt="" width="20" height="20" class="">
                                        </a>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a class="btn btn-add fw-bold" href="" role="button">CREATE NEW BACKUP</a>
                        </div>
                    </div>
                    <div class="col-12">
