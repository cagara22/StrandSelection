	...
	<header class="d-flex justify-content-center align-items-center p-5" id="Home">
		<div class="row">
			<div class="col-12 order-2 order-lg-1 col-lg-8 text-wrap text-center align-self-center">
				<h1 class="text-body-emphasis fw-bold">HUMSS</h1>
				...
				?>
				<button type="button" class="btn btn-outline-success btn-lg fw-bold fs-3 m-2" onclick="set_exam_type_session('HUMSS');">Take Assessment</button>
