				...
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					...
					<form action="" method="post">
						...
						<div class="form-outline mb-4">
							...
							<input type="number" id="username" name="lrn" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" class="form-control form-control-lg" placeholder="Enter a valid LRN" />
						</div>
				...
				<div class="modal-body">
					...
					<form class="row" action="" method="post">
						...
						<div class="col-12 mb-3">
							...
							<input type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" class="form-control" id="lrn" name="lrn2" placeholder="">
						</div>
						...
						<div class="col-12 col-md-6 mb-3">
							...
							<input type="text" class="form-control" id="Age" name="age" placeholder="" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="3">
						</div>
						<div class="col-12 mb-3">
						...
						<div class="col-12 col-md-6 mb-3">
							...
							<input type="password" class="form-control" minlength="8" id="example-getting-started-input" name="password2" placeholder="" required>
