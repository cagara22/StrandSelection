		...
		<div class="row" style="width:70%">
			...
			<form class="row" action="" method="post">
				...
				<div class="col-12 col-md-4 mb-3">
					...
					<input type="text" class="form-control" id="Name" name="Fname" value="<?php echo $Fname1; ?>" oninput="validateFirstName(this)" placeholder="" required>
				</div>
				<div class="col-12 col-md-4 mb-3">
					<label for="Name" class="form-label"> Middle Name</label>
					<input type="text" class="form-control" id="Name" name="Mname" value="<?php echo $Mname1; ?>" oninput="validateMiddleName(this)" placeholder="" required>
				</div>
				<div class="col-12 col-md-4 mb-3">
					<label for="Name" class="form-label"> Last Name</label>
					<input type="text" class="form-control" id="Name" name="Lname" value="<?php echo $Lname1; ?>" oninput="validateLastName(this)" placeholder="" required>
				</div>
				<div class="col-12 mb-3">
					<label for="Address" class="form-label">Address</label>
					<input type="text" class="form-control" id="Address" name="address" value="<?php echo $address1; ?>" oninput="validateAddress(this)" placeholder="" required>
				</div>
				<div class="col-12 col-md-4 mb-3">
					<label class="form-label" for="Gender">Gender</label>
					<select class="form-select" id="Gender" name="sex" value="<?php echo $sex1; ?>">
				...
				<div class="col-12 col-md-4 mb-3">
					...
					<select class="form-select" id="CivilStatus" name="civilstatus">
						<option selected value="Single" <?php if ($civilstatus1 == "Single") {
															echo " selected";
														} ?>>Single</option>
						<option value="In a Relationship" <?php if ($civilstatus1 == "In a Relationship") {
																echo " selected";
															} ?>>In a Relationship</option>
						<option value="Married" <?php if ($civilstatus1 == "Married") {
													echo " selected";
												} ?>>Married</option>
						<option value="Divorced" <?php if ($civilstatus1 == "Divorced") {
														echo " selected";
													} ?>>Divorced</option>
						<option value="Separated" <?php if ($civilstatus1 == "Separated") {
														echo " selected";
													} ?>>Separated</option>
						<option value="Widowed" <?php if ($civilstatus1 == "Widowed") {
													echo " selected";
												} ?>>Widowed</option>
					</select>
				</div>
				<div class="col-12 col-md-4 mb-3">
					...
					<input type="text" class="form-control" id="Age" name="age" value="<?php echo $age1; ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="3" placeholder="" required>
				</div>
				<div class="col-12 col-md-6 mb-3">
					<label for="lrn" class="form-label">LRN</label>
					<input type="text" class="form-control" id="lrn" name="lrn" value="<?php echo $lrn1; ?>" placeholder="" disabled>
				</div>
				<div class="col-12 col-md-6 mb-3">
					<label for="Email" class="form-label">Email</label>
					<input type="email" class="form-control" id="Email" name="email" value="<?php echo $email1; ?>" placeholder="" required>
				</div>
				...
				<div class="col-12 col-md-6 col-lg-3 mb-3">
					...
					<select class="form-select" id="Science" name="Science">
						<option value="100 - 95" <?php if ($science21 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($science21 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						...
						<option value="69 - 0" <?php if ($science21 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
				</div>
				<div class="col-12 col-md-6 col-lg-3 mb-3">
					...
					<select class="form-select" id="Math" name="Math">
						<option value="100 - 95" <?php if ($math11 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($math11 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						<option value="89 - 80" <?php if ($math11 == "89 - 80") {
													echo " selected";
												} ?>>89 - 80</option>
						<option value="79 - 75" <?php if ($math11 == "79 - 75") {
													echo " selected";
												} ?>>79 - 75</option>
						<option value="74 - 70" <?php if ($math11 == "74 - 70") {
													echo " selected";
												} ?>>74 - 70</option>
						<option value="69 - 0" <?php if ($math11 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
				</div>
				<div class="col-12 col-md-6 col-lg-3 mb-3">
					...
					<select class="form-select" id="English" name="English">
						<option value="100 - 95" <?php if ($English1 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($English1 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						<option value="89 - 80" <?php if ($English1 == "89 - 80") {
													echo " selected";
												} ?>>89 - 80</option>
						<option value="79 - 75" <?php if ($English1 == "79 - 75") {
													echo " selected";
												} ?>>79 - 75</option>
						<option value="74 - 70" <?php if ($English1 == "74 - 70") {
													echo " selected";
												} ?>>74 - 70</option>
						<option value="69 - 0" <?php if ($English1 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
				</div>
				<div class="col-12 col-md-6 col-lg-3 mb-3">
					...
					<select class="form-select" id="Filipino" name="Filipino">
						<option value="100 - 95" <?php if ($Filipino1 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($Filipino1 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						<option value="89 - 80" <?php if ($Filipino1 == "89 - 80") {
													echo " selected";
												} ?>>89 - 80</option>
						<option value="79 - 75" <?php if ($Filipino1 == "79 - 75") {
													echo " selected";
												} ?>>79 - 75</option>
						<option value="74 - 70" <?php if ($Filipino1 == "74 - 70") {
													echo " selected";
												} ?>>74 - 70</option>
						<option value="69 - 0" <?php if ($Filipino1 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
				</div>
				<div class="col-12 col-md-6 mb-3">
					...
					<select class="form-select" id="ICTRelatedSubject" name="ICTRelatedSubject">
						<option value="N/A" <?php if ($ICTRelatedSubject1 == "N/A") {
												echo " selected";
											} ?>>N/A</option>
						<option value="100 - 95" <?php if ($ICTRelatedSubject1 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($ICTRelatedSubject1 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						<option value="89 - 80" <?php if ($ICTRelatedSubject1 == "89 - 80") {
													echo " selected";
												} ?>>89 - 80</option>
						<option value="79 - 75" <?php if ($ICTRelatedSubject1 == "79 - 75") {
													echo " selected";
												} ?>>79 - 75</option>
						<option value="74 - 70" <?php if ($ICTRelatedSubject1 == "74 - 70") {
													echo " selected";
												} ?>>74 - 70</option>
						<option value="69 - 0" <?php if ($ICTRelatedSubject1 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
				...
				<div class="col-12 col-md-6 mb-3">
					...
					<select class="form-select" id="HERelatedSubject" name="HERelatedSubject">
						<option value="N/A" <?php if ($HERelatedSubject1 == "N/A") {
												echo " selected";
											} ?>>N/A</option>
						<option value="100 - 95" <?php if ($HERelatedSubject1 == "100 - 95") {
														echo " selected";
													} ?>>100 - 95</option>
						<option value="94 - 90" <?php if ($HERelatedSubject1 == "94 - 90") {
													echo " selected";
												} ?>>94 - 90</option>
						<option value="89 - 80" <?php if ($HERelatedSubject1 == "89 - 80") {
													echo " selected";
												} ?>>89 - 80</option>
						<option value="79 - 75" <?php if ($HERelatedSubject1 == "79 - 75") {
													echo " selected";
												} ?>>79 - 75</option>
						<option value="74 - 70" <?php if ($HERelatedSubject1 == "74 - 70") {
													echo " selected";
												} ?>>74 - 70</option>
						<option value="69 - 0" <?php if ($HERelatedSubject1 == "69 - 0") {
													echo " selected";
												} ?>>69 - 0</option>
					</select>
					<small id="" class="form-text text-muted">This is optional... Leave blank if not applicable</small>
				...
				<div class="col-12">
					<div class="mb-3">
						...
						<select class="form-select" id="TotalMonthlyIncome" name="TotalMonthlyIncome">
							<option selected value="less than P9,100" <?php if ($TotalMonthlyIncome == "less than P9,100") {
																			echo " selected";
																		} ?>>less than P9,100</option>
							<option value="P9,100-P18,200" <?php if ($TotalMonthlyIncome == "P9,100-P18,200") {
																echo " selected";
															} ?>>P9,100-P18,200</option>
							<option value="P18,200-P36,400" <?php if ($TotalMonthlyIncome == "P18,200-P36,400") {
																echo " selected";
															} ?>>P18,200-P36,400</option>
							<option value="P36,400-P63,700" <?php if ($TotalMonthlyIncome == "P36,400-P63,700") {
																echo " selected";
															} ?>>P36,400-P63,700</option>
							<option value="P63,700-P109,200" <?php if ($TotalMonthlyIncome == "P63,700-P109,200") {
																	echo " selected";
																} ?>>P63,700-P109,200</option>
							<option value="P109,200-P182,000" <?php if ($TotalMonthlyIncome == "P109,200-P182,000") {
																	echo " selected";
																} ?>>P109,200-P182,000</option>
							<option value="greater than P182,000" <?php if ($TotalMonthlyIncome == "greater than P182,000") {
																		echo " selected";
				...
				<div class="col-12 col-md-6">
					...
					<div>
						...
						<input type="range" class="form-range" min="0" max="10" id="ScienceSub" name="ScienceSub" value="<?php echo $science1 ?>">
					</div>
					<div>
						<label for="MathSub" class="form-label">Math</label>
						<input type="range" class="form-range" min="0" max="10" id="MathSub" name="MathSub" value="<?php echo $math1 ?>">
					</div>
					<div>
						<label for="ArtsandDesign" class="form-label">Arts and Design</label>
						<input type="range" class="form-range" min="0" max="10" id="ArtsandDesign" name="ArtsandDesign" value="<?php echo $arts1 ?>">
					</div>
					<div>
						<label for="Humanities" class="form-label">Humanities and Social Sciences</label>
						<input type="range" class="form-range" min="0" max="10" id="Humanities" name="Humanities" value="<?php echo $humanities1 ?>">
					</div>
					<div>
						<label for="Entrepreneurship" class="form-label">Business and Entrepreneurship</label>
						<input type="range" class="form-range" min="0" max="10" id="Entrepreneurship" name="Entrepreneurship" value="<?php echo $entrepreneurship1 ?>">
					</div>
					<div>
						<label for="Information" class="form-label">Information and Communication Technology</label>
						<input type="range" class="form-range" min="0" max="10" id="Information" name="Information" value="<?php echo $information1 ?>">
					</div>
					<div>
						<label for="Agriculture" class="form-label">Agriculture and Fisheries</label>
						<input type="range" class="form-range" min="0" max="10" id="Agriculture" name="Agriculture" value="<?php echo $agriculture1 ?>">
					</div>
					<div>
						<label for="HomeEconomics" class="form-label">Home Economics</label>
						<input type="range" class="form-range" min="0" max="10" id="HomeEconomics" name="HomeEconomics" value="<?php echo $homeEconomics1 ?>">
					</div>
					<div>
						<label for="IndustrialArts" class="form-label">Industrial Arts and Technology</label>
						<input type="range" class="form-range" min="0" max="10" id="IndustrialArts" name="IndustrialArts" value="<?php echo $industrialArts1 ?>">
					</div>
				</div>
				<div>
					...
					<select class="form-select" id="CareerGoals" name="CareerGoals">
						<option value="Undecided" <?php if ($CareerGoals1 == "Undecided") {
														echo " selected";
													} ?>>Undecided</option>
						<option value="Business and Management" <?php if ($CareerGoals1 == "Business and Management") {
																	echo " selected";
																} ?>>Business and Management</option>
						<option value="Education and Training" <?php if ($CareerGoals1 == "Education and Training") {
																	echo " selected";
																} ?>>Education and Training</option>
						<option value="Engineering and Technology" <?php if ($CareerGoals1 == "Engineering and Technology") {
																		echo " selected";
																	} ?>>Engineering and Technology</option>
						<option value="Healthcare and Medicine" <?php if ($CareerGoals1 == "Healthcare and Medicine") {
																	echo " selected";
																} ?>>Healthcare and Medicine</option>
						<option value="Arts and Humanities" <?php if ($CareerGoals1 == "Arts and Humanities") {
																echo " selected";
															} ?>>Arts and Humanities</option>
						<option value="Law and Public Policy" <?php if ($CareerGoals1 == "Law and Public Policy") {
																	echo " selected";
																} ?>>Law and Public Policy</option>
						<option value="Natural Sciences and Mathematics" <?php if ($CareerGoals1 == "Natural Sciences and Mathematics") {
																				echo " selected";
																			} ?>>Natural Sciences and Mathematics</option>
						<option value="Social Sciences and Communication" <?php if ($CareerGoals1 == "Social Sciences and Communication") {
																				echo " selected";
																			} ?>>Social Sciences and Communication</option>
						<option value="Information Technology and Computer Science" <?php if ($CareerGoals1 == "Information Technology and Computer Science") {
																						echo " selected";
																					} ?>>Information Technology and Computer Science</option>
						<option value="Agriculture and Environmental Science" <?php if ($CareerGoals1 == "Agriculture and Environmental Science") {
																					echo " selected";
																				} ?>>Agriculture and Environmental Science</option>
						<option value="Hospitality and Tourism" <?php if ($CareerGoals1 == "Hospitality and Tourism") {
																	echo " selected";
																} ?>>Hospitality and Tourism</option>
						<option value="Media and Entertainment" <?php if ($CareerGoals1 == "Media and Entertainment") {
																	echo " selected";
																} ?>>Media and Entertainment</option>
						<option value="Sports and Fitness" <?php if ($CareerGoals1 == "Sports and Fitness") {
																echo " selected";
															} ?>>Sports and Fitness</option>
						<option value="Trades and Vocational Skills" <?php if ($CareerGoals1 == "Trades and Vocational Skills") {
																			echo " selected";
																		} ?>>Trades and Vocational Skills</option>
						<option value="Government and Public Service" <?php if ($CareerGoals1 == "Government and Public Service") {
																			echo " selected";
																		} ?>>Government and Public Service</option>
						<option value="Non-Profit and Philanthropy" <?php if ($CareerGoals1 == "Non-Profit and Philanthropy") {
																		echo " selected";
				...
				<div class="col-12 mb-3">
					...
					<input type="text" class="form-control" id="predictedStrand" name="predictedStrand" value="<?php echo $strand1 ?>" placeholder="Your predicted strand...">
				</div>
