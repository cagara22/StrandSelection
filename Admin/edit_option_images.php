...
<label for="company" class=" form-control-label">
    Add Question</label><input type="text" name ="fquestion" placeholder="Add question" class="form-control" 
    ...
    <label for="company" class=" form-control-label">
    Add option 3 </label>
    <input type="file" name ="fopt3"  class="form-control"></div>
    ...
    <div class="form-group"> 
        ...
        <input type="submit" name = "submit2" value = "Update Question"  placeholder="" class="btn btn-success"></div>
