...
if(isset($_GET['searchname'])) {
    ...
    $sql = "SELECT * FROM student WHERE strand LIKE '%HUMSS%' LIMIT $offset, $total_records_per_page";
}
...
$sql = "SELECT COUNT(*) AS total_records FROM student WHERE strand LIKE '%HUMSS%'";
$result = $conn->query($sql);
