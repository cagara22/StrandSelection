		...
		<div class="row" style="width:70%">
			...
			<form class="row" action="" method="post">
				...
				<div class="col-12 mb-3">
					...
					<input type="text" class="form-control" id="Name" name="fullname" value="<?php echo $fullname1; ?>" placeholder="" required>
				</div>
				<div class="col-12 mb-3">
					<label for="Address" class="form-label">Address</label>
					<input type="text" class="form-control" id="Address" name="address" value="<?php echo $address1; ?>" placeholder="" required>
				</div>
				<div class="col-12 mb-3">
					<label for="ContactNumber" class="form-label">Contact Number</label>
					<input type="text" class="form-control" id="ContactNumber" name="contactnumber" value="<?php echo $contactnumber1; ?>" placeholder="" required>
				</div>
				<div class="col-12 mb-3">
					<label for="UserName" class="form-label"> Username</label>
					<input type="text" class="form-control" id="UserName" name="username" value="<?php echo $username1; ?>" placeholder="" required>
				</div>
					...
					inputFields.forEach((input) => {
						input.addEventListener('keydown', (e) => {
							if (e.keyCode === 38) { // Left arrow key38
								...
								const nextField = fieldMap[input.id];
								40
								if (nextField) {
