...
<body>
	...
	<div class="row"  style="min-height: 500px;">
			<div class="col-12 order-2 order-lg-1 col-lg-8 text-wrap text-center align-self-center">
				<h1 class="text-body-emphasis fw-bold">HE</h1>
				...
				?>
				<button type="button" class="btn btn-outline-success btn-lg fw-bold fs-3 m-2" onclick="set_exam_type_session('HE');">Take Assessment</button>
